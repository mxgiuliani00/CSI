function [options,objFunOptions] = getAlgorithmOptions2(algorithm,data,varargin)
...
objFunOptions.nUnits         = 20;          % number of units in ELM
...
elseif strcmp(algorithm,'BORG')
    ...
    options.NFE         = 10000;                % number of functions evaluations
